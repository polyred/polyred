...
func TestVec_New(t *testing.T) {
	...
	t.Run("Vec3", func(t *testing.T) {
		v1 := math.NewVec3(1, 1, 2)
		v2 := math.NewVec3(2, 2, 2)
		v3 := math.NewVec3(1, 1, 2)
		if v1.Eq(v2) {
			t.Fatalf("unexpected comparison, got true, want false")
		}
		if !v1.Eq(v3) {
	...
	t.Run("Vec4", func(t *testing.T) {
		v1 := math.NewVec4(1, 1, 4, 2)
		v2 := math.NewVec4(2, 2, 4, 2)
		v3 := math.NewVec4(1, 1, 4, 2)
		if v1.Eq(v2) {
			t.Fatalf("unexpected comparison, got true, want false")
		}
		if !v1.Eq(v3) {
...
func TestVec_Translate(t *testing.T) {
	...
	t.Run("Vec4", func(t *testing.T) {
		v1 := math.NewVec4(1, 1, 1, 1)
		got := v1.Translate(2, 2, 2)
		want := math.NewVec4(3, 3, 3, 1)
		if !got.Eq(want) {
			t.Fatalf("unexpected translate, want %v, got %v", want, got)
		}

		v2 := math.NewVec4(1, 1, 1, 0)
		got = v2.Translate(2, 2, 2)
		want = math.NewVec4(1, 1, 1, 0)
		if !got.Eq(want) {
			t.Fatalf("unexpected translate, want %v, got %v", want, got)
		}
	})
...
func TestVec_Unit(t *testing.T) {
	t.Run("Vec2", func(t *testing.T) {
		v1 := math.NewVec2(1, 1)
		got := v1.Unit()
		want := math.NewVec2(1/math.Sqrt(2), 1/math.Sqrt(2))
		if !got.Eq(want) {
			t.Fatalf("unexpected Len, want %v, got %v", want, got)
		}
	})
	t.Run("Vec3", func(t *testing.T) {
		v1 := math.NewVec3(1, 1, 1)
		got := v1.Unit()
		want := math.NewVec3(1/math.Sqrt(3), 1/math.Sqrt(3), 1/math.Sqrt(3))
		if !got.Eq(want) {
			t.Fatalf("unexpected Len, want %v, got %v", want, got)
		}
	})
	...
	t.Run("Vec4", func(t *testing.T) {
		v1 := math.NewVec4(1, 1, 1, 0)
		got := v1.Unit()
		want := math.NewVec4(1/math.Sqrt(3), 1/math.Sqrt(3), 1/math.Sqrt(3), 0)
		if !got.Eq(want) {
			t.Fatalf("unexpected Len, want %v, got %v", want, got)
		}
		...
		v1 = math.NewVec4(1, 1, 1, 1)
		got = v1.Unit()
		want = math.NewVec4(0.5, 0.5, 0.5, 0.5)
		if !got.Eq(want) {
			t.Fatalf("unexpected Len, want %v, got %v", want, got)
		}
	})
...
func TestVec_Cross(t *testing.T) {
	...
	t.Run("Vec4", func(t *testing.T) {
		v1 := math.NewVec4(1, 0, 0, 0)
		v2 := math.NewVec4(0, 1, 0, 0)
		want := math.NewVec4(0, 0, 1, 0)
		got := v1.Cross(v2)
		if !got.Eq(want) {
			t.Fatalf("unexpected Cross, want %v, got %v", want, got)
		}
...
func TestVec_Convert(t *testing.T) {
	...
	t.Run("Vec4_Pos", func(t *testing.T) {
		...
		v2 := math.NewVec4(1, 1, 1, 0)
		got = v2.Pos()
		want = math.NewVec4(1, 1, 1, 1)
		if !got.Eq(want) {
			t.Fatalf("unexpected Pos, got %v, want %v", got, want)
		}

		v2 = math.NewVec4(1, 1, 1, 1)
		got = v2.Pos()
		want = math.NewVec4(1, 1, 1, 1)
		if !got.Eq(want) {
			t.Fatalf("unexpected Pos, got %v, want %v", got, want)
