...
func prepare() (*render.Renderer, *render.Buffer, shader.Program, []uint64, []*primitive.Vertex) {
	...
	r := render.NewRenderer(render.WithSize(500, 500))
